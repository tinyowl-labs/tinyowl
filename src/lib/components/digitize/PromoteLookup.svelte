    ...
    <div class="flex flex-col gap-4">
        <div>
            ...
            <p class="text-xs text-muted-foreground mt-0.5 max-w-xl">
                Copy distinct values into a lookup table and rewrite the column
                to those ids. One commit on develop. Adding a term later is a
                lookup row, not a TOML edit.
            </p>
        </div>
